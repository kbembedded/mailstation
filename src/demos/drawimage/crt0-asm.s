	...
	; This crt0 still does a lot of the Mailstation setup steps, but it is
	; meant to link against full assembly projects. This is just a stop-gap
	; solution for the time being, and hopefully this should all get cleaned
	; up later.
	; Specifically, this file drops definitions for l_INITIALIZER,
	; s_INITIALIZED, and s_INITIALIZER. All three of which are emitted from
	; sdcc, but not sdasz80

	; Originally created by FyberOptic and/or Cyrano Jones
